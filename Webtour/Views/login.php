	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('./Public/client/img/bg-01.jpg');">
			<div class="wrap-login100 p-t-30 p-b-50">
				...
				<form class="login100-form validate-form p-b-33 p-t-5" action="./?action=index" method="POST">
					...
					<div class="wrap-input100 validate-input" data-validate="Enter password">
						...
						<span class="focus-input100"><img style="margin-top: 40px;margin-left: 34px;" width="22px" src="./Public/client/img/icons/password-login.png" alt=""></span>
					</div>
					...
					<div class="container-login100-form-btn m-t-32">
						<i>Do you have account?<a href="./?action=sign">Signup</a></i>
					</div>
